...
template <typename SUBNET> using level3 = res<16*FNUM,res_down<16*FNUM,SUBNET>>;
...
template <typename SUBNET> using alevel3 = ares<16*FNUM,ares_down<16*FNUM,SUBNET>>;
...
using net_type =    loss_multimulticlass_log<fc<4,avg_pool_everything<
                            level5<
                            level6<
...
using anet_type =   loss_multimulticlass_log<fc<4,avg_pool_everything<
                            alevel5<
                            alevel6<
