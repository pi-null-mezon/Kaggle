...
template <typename SUBNET> using level0 = res_down<1024,SUBNET>;
...
template <typename SUBNET> using level4 = res_down<64,SUBNET>;
template <typename SUBNET> using level5 = res_down<32,SUBNET>;

template <typename SUBNET> using alevel0 = ares_down<1024,SUBNET>;
...
template <typename SUBNET> using alevel4 = ares_down<64,SUBNET>;
template <typename SUBNET> using alevel5 = ares_down<32,SUBNET>;
