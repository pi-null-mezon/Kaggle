...
int main(int argc, char** argv) try
{
    ...
    load_image_dataset(images_train, boxes_train, "/home/alex/Testdata/Flukes/Train/Flukes.xml");
    load_image_dataset(images_test,  boxes_test,  "/home/alex/Testdata/Flukes/Test/Flukes.xml");
    ...
    while(trainer.get_learning_rate() >= 1e-4)
    {
        ...
        {
            cropper(50, images_train, boxes_train, mini_batch_samples, mini_batch_labels);
        ...
        {
            cropper(50, images_test, boxes_test, mini_batch_samples, mini_batch_labels);
            // We can also randomly jitter the colors and that often helps a detector
            // generalize better to new images.
            for (auto&& img : mini_batch_samples)
                disturb_colors(img, rnd);
    ...
    net.clean();
    serialize("flukes_detector.dat") << net;
    ...
    upsample_image_dataset<pyramid_down<2>>(images_train, boxes_train, 1800*900);
    ...
    upsample_image_dataset<pyramid_down<2>>(images_test, boxes_test, 1800*900);
