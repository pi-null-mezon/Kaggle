...
template <typename SUBNET> using level0 = res_down<16*FNUM,SUBNET>;
template <typename SUBNET> using level1 = res_down<8*FNUM,SUBNET>;
template <typename SUBNET> using level2 = res_down<4*FNUM,SUBNET>;
template <typename SUBNET> using level3 = res_down<2*FNUM,SUBNET>;
template <typename SUBNET> using level4 = res<FNUM,SUBNET>;

template <typename SUBNET> using alevel0 = ares_down<16*FNUM,SUBNET>;
template <typename SUBNET> using alevel1 = ares_down<8*FNUM,SUBNET>;
template <typename SUBNET> using alevel2 = ares_down<4*FNUM,SUBNET>;
template <typename SUBNET> using alevel3 = ares_down<2*FNUM,SUBNET>;
template <typename SUBNET> using alevel4 = ares<FNUM,SUBNET>;
