...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, zero_init_residual=False,
        ...
        self.layer4 = self._make_layer(block, 36, layers[3], stride=2,
                                       dilate=replace_stride_with_dilation[2])
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1))
        self.fc1 = nn.Linear(36 * block.expansion, num_classes)
...
class MobileNetV2(nn.Module):
    def __init__(self,
        ...
        self.fc1 = nn.Linear(self.last_channel, 136)  # for landmarks
        self.fc2 = nn.Linear(self.last_channel, 3)  # for pitch, yaw, roll
